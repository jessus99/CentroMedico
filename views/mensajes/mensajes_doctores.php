...
?>
<div id="box_mensajesDoctores" class="card bg-secondary mb-3 mx-auto" style="margin-top:10px">
                ...
                <form id="form_profesionales_mensajes" action="" method="POST">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="mensaje" style="height:150px" id="mensaje" rows="5"></textarea>
                                </div>
                        ...
                        <div class="">
                                ...
                                <input type="button" id="" value="Cerrare" onclick="fn_cerrar_mensaje()" class="btn btn-outline-warning">
                        </div>
                </form>
        </div>
</div>