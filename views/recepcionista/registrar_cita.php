        ...
        <div class="card-body">
                <form id="form_registro_citas" action="" method="POST">
                        ...
                        <div class="modal-body">
                                ...
                                <label for="exampleSelect2">Nombre de Paciente:</label>
                                        <select class="form-select" name="nombre_paciente" id="exampleSelect2">
                                                <?php
                                                foreach ($respuestaUsuarios as $respuesta) {
                                                        if ($respuesta['perfil'] == "Paciente") {
                                                ?>
                                                                <option value="<?= $respuesta['name'] ?>"><?= $respuesta['name'] . ", " . $respuesta['perfil'] ?></option>
                                                <?php
                                                        }
                                                }
                                                ?>
                                        </select><br>
                                        <label for="exampleSelect2">nombre de cita</label>
                                        ...
                                        <label for="exampleSelect2">nombre del Doctor a cargo</label>
                                        <select class="form-select" name="nombre_doctor" id="exampleSelect2">
                                                <?php
                                                foreach ($respuestaUsuarios as $respuesta) {
                                                        if ($respuesta['perfil'] == "Doctor") {
                                                ?>
                                                                <option value="<?= $respuesta['name'] ?>"><?= $respuesta['name'] . ", " . $respuesta['perfil'] ?></option>
                                                <?php
                                                        }
